    ...
    fn has_relation_to_impl(
        ...
        match other {
            ...
            Tuple::Variable(other) => {
                ...
                result.and(db, || {
                    self_iter.when_all(db, constraints, |constraints, self_ty| {
                        self_ty.has_relation_to_impl(
                            db,
                            other.variable(),
                            constraints,
        ...
        self.variable()
            ...
            .and(db, || {
                self.prenormalized_prefix_elements(db, None)
                    ...
                    .when_all(db, constraints, |constraints, pair| match pair {
...
impl<'db> Tuple<Type<'db>> {
    ...
    pub(super) fn is_disjoint_from_impl(
        ...
        {
            if rev {
                a.iter().rev().zip(b.iter().rev()).when_any(
                    db,
                    constraints,
                    |constraints, (self_element, other_element)| {
